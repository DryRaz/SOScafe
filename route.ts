...
export async function POST(req: NextRequest) {
  ...
  // Source de vérité : on relit prix + disponibilité en base, on ne fait
  // jamais confiance au prix envoyé par le client.
  ...
  // ------------------------------------------------------------------
  // TEMPORAIRE (Phase 3) : la commande est marquée "paid" immédiatement,
  // sans paiement réel. Ceci sert uniquement à valider l'UX de commande
  // avant de brancher M-Pesa (Phase 4). À retirer avant toute mise en
  // production — remplacer par status: 'awaiting_payment' + déclenchement
  // du STK Push.
  // ------------------------------------------------------------------
